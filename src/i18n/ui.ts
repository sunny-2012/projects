...
export const ui = {
	en: {
		...
		"websites.content": "At Magestic Work, we specialize in crafting bespoke websites tailored to your brand's needs. Our approach combines aesthetic design with technical proficiency, ensuring your site is visually stunning, fast, and responsive across all devices.",
		...
		"seo.content": "Magestic Work's SEO services are designed to increase your website's visibility and drive organic traffic. We use a blend of the latest SEO strategies and techniques to improve your search engine rankings, focusing on both on-page and off-page optimization.",
		"analytics.content": "We provide comprehensive analytics dashboards to track your business performance, user engagement, and conversion metrics in real-time. Gain actionable insights to optimize your digital strategy.",
	...
	it: {
		...
		"hero.title.3": "design",
		"hero.title.4": "brand",
		"hero.title.5": "analytics dashboard",
		"hero.subtitle":
		...
		"seo.title": "SEO",
		"analytics.title": "Dashboard Analitica",
		"advertising.title": "Pubblicità",
		"websites.content": "Da Magestic Work, siamo specializzati nella realizzazione di siti web su misura per le esigenze del tuo marchio. Il nostro approccio combina design estetico con competenza tecnica, garantendo che il tuo sito sia visivamente accattivante, veloce e reattivo su tutti i dispositivi.",
		...
		"seo.content": "I servizi SEO di Magestic Work sono progettati per aumentare la visibilità del tuo sito web e generare traffico organico. Utilizziamo una combinazione delle più recenti strategie e tecniche SEO per migliorare il tuo posizionamento sui motori di ricerca, concentrando sia sull'ottimizzazione on-page che off-page.",
		"analytics.content": "Forniamo dashboard analitiche complete per monitorare le prestazioni aziendali, il coinvolgimento degli utenti e le metriche di conversione in tempo reale. Ottieni approfondimenti utilizzabili per ottimizzare la tua strategia digitale.",
